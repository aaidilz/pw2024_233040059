    ...
    <section>
        <div class="container">
            ...
            <form action="index.php" method="POST">
                <div class="text-warp">
                    <input class="text-container" type="text" name="username" placeholder="Username" required>
                    <input class="text-container" type="password" name="password" placeholder="Password" required>
